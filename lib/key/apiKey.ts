...
//     try {
//       const decoded = jwt.verify(matchedRecord.jwt, JWT_SECRET) as any;
      
//       // ✅ Check if user has active subscription (not free plan)
//       const userSubscription = await database.user.findFirst({
...
//       // For trial keys, allow usage regardless of subscription status
//       if (!matchedRecord.isTrial) {
//         // For production keys, require active premium subscription
//         if (!userSubscription || 
//             userSubscription.plan === "FREE" || 
//             userSubscription.subscriptionStatus !== "ACTIVE") {
//           return { 
//             valid: false, 
//             message: "Active premium subscription required to use API keys" 
//           };
//         }
//       }
