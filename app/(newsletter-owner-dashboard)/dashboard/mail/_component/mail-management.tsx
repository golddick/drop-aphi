...
//                 <p className="text-black mt-2">Create, manage, and track your email campaigns</p>
//               </div>
//               <Link href={"/dashboard/mail/write"}>
//                 <Button className="bg-black text-white hover:bg-white hover:text-black font-semibold">
...
//                       <p className="text-2xl font-bold text-black">{stats.sentEmails}</p>
//                     </div>
...
//                       <p className="text-2xl font-bold text-black">{stats.totalRecipients.toLocaleString()}</p>
//                     </div>
...
//                 <SelectTrigger className="w-32 border-gray-300 focus:border-black focus:ring-black">
...
//                       <p className="text-gray-600 mb-3">{email.previewText}</p>
...
import Link from "next/link"
import { EmailStats, getEmails, getEmailStats } from "@/actions/email/email-actions"
import { deleteEmail, duplicateEmail } from "@/actions/email/emails"
